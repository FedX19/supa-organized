...
// NOTE: The plan-notification funnel was REMOVED (2026-08-04).
// It queried 7 event_type values (player_plan_notification_created,
// player_plan_email_sent/opened/clicked, player_plan_login_completed,
// player_plan_viewed, player_plan_drill_opened). A grep of the UniteHQ
// codebase found ZERO occurrences of any of them — nothing ever emitted these
// events, so the widget could only ever render empty. An always-empty funnel
// reads as "nobody opens their plan emails", which is materially misleading.
// Rebuild it from assessments -> generated_plans -> plan-open events instead.
